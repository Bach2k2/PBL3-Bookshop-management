                    ...
                    <c:forEach var="OrderdetailShow" items="${listOrderdetailShow}">
                        <form method = POST>
                            <tr>
                                ...
                                <td><a href="Productdetail?ID_Product=<c:out value='${OrderdetailShow.getID_Product()}' />&ID_U=<c:out value='${ID_U}' />"><img alt="" src="themes/images/cloth/thebook ${OrderdetailShow.getID_Product()}.jpg"></a></td>
                                    ...
                                    <ul class="thumbnails listing-products">
                                        <li class="span3">
                                            <div class="product-box">
                                                ...
                                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />&ID_U=<c:out value='${ID_U}' />"><img alt="" src="themes/images/cloth/thebook ${ProductShow.getID_Product()}.jpg"></a><br/>
                                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />&ID_U=<c:out value='${ID_U}' />" class="title">${ProductShow.getBook_title()}</a><br/>
                                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />&ID_U=<c:out value='${ID_U}' />" class="category">${ProductShow.getCategory_name()}</a>
