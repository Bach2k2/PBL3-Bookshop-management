...
<head>
    ...
    <link href="<%=request.getContextPath()%>/bootstrap/css/bootstrap-responsive.min.css" type="text/css"
          rel="stylesheet">
...
<div id="wrapper" class="container">
    ...
    <section class="homepage-slider" id="home-slider">
        <div class="flexslider">
            <ul class="slides">
                <li>
                    <img src="../themes/images/carousel/book_slider1.jpg" alt="anh bia 1"/>
                    <%--                    <div class="intro">--%>
...
<%--                    <img src="<%=request.getContextPath()%>/themes/images/carousel/slider_4.png" alt="anh bia 2" />--%>
                    <img src="<%=request.getContextPath()%>/themes/images/carousel/book_slider2.jpg" alt="anh bia 2"/>
                </li>
                <li>
<%--                   <img src="<%=request.getContextPath()%>/themes/images/carousel/slider_5.png" alt="anh bia 3" />--%>
                    <img src="<%=request.getContextPath()%>/themes/images/carousel/book_slider6.jpg" alt="anh bia 3"/>
                </li>
                <li>
                    <img src="<%=request.getContextPath()%>/themes/images/carousel/book_slider7.jpg" alt="anh bia 4"/>
                </li>
                <li>
                    <img src="<%=request.getContextPath()%>/themes/images/carousel/book_slider5.jpg" alt="anh bia 4"/>
                </li>
            </ul>
        </div>
    </section>
                    ...
                    <c:forEach var="productShow" items="${listProductShow}">
                        <li class="span3">
                            <div class="product-box">
                                ...
                                <a href="/productDetail?idProduct=<c:out value='${productShow.getIdProduct()}' />">
                                    <img alt="Hiển thị ảnh nè"
                                ...
                                <div class="active item">
                                    <ul class="thumbnails listing-products">
                                        <li class="span3">
                                            <div class="product-box">
                                                <span class="sale_tag"></span>
                                                <a href="productDetail?idProduct=<c:out value='${productShow.getIdProduct()}' />"><img
