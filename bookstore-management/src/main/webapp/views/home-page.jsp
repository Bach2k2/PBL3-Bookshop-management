...
<%--                  <li> <a href="about.html">About us</a> </li>--%>
                  <li><a href="/home?action=book">Our Books</a></li>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption relative">
            ...
            <p><br> labore et dolore magna aliqua. Ut enim ad minim<br> veniam, quis nostrud exercitation </p>
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption relative">
            <h1>The Best Libraries That<br> Every Book Lover Must<br> Visit!</h1>
            <p>Nhà sách NBM hoạt động tại 60 Ngô Sĩ Liên<br> Hãy đén với chúng tôi<br> Love you </p>
            <div class="button_section"> <a class="main_bt" href="#">Read More</a>  </div>
            <ul class="locat_icon">
              <li> <a href="#"><img src="../icon/facebook.png"></a></li>
              <li> <a href="#"><img src="../icon/Twitter.png"></a></li>
