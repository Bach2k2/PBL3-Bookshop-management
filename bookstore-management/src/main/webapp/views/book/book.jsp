...
<head>
    ...
    <!-- bootstrap -->
    <link href='<c:url value="<%=request.getContextPath()%>/bootstrap/css/bootstrap.min.css"/>' rel="stylesheet">
    <link href="<%=request.getContextPath()%>/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
    <link href="<%=request.getContextPath()%>/themes/css/bootstrappage.css" rel="stylesheet"/>
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/themes/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/themes/css/font-awesome.min2.css">
    <%--    themes--%>
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>s/themes/css/font-awesome.min3.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.0.10/css/all.css"
          integrity="sha384-+d0P83n9kaQMCwj8F4RJB66tzIwOKmrdb46+porD/OvrJ+37WqIM7UoBtwHO6Nlg" crossorigin="anonymous">
    <link href="<%=request.getContextPath()%>/themes/css/flexslider.css" rel="stylesheet"/>
    <link href="<%=request.getContextPath()%>/themes/css/main.css" rel="stylesheet"/>
    ...
    <div class="row">
        ...
        <div class="span8">
            <div class="account pull-right">
                <ul class="user-menu">
                    <c:if test="${User == null}">
                        <li><a href="${pageContext.request.contextPath}/home?action=register">Tài khoản</a></li>
                    </c:if>
                    <li><a href="/cart">Giỏ hàng</a></li>
                    <li><a href="/checkout">Thanh toán</a></li>
                    <c:if test="${User == null}">
                        <li><a href="${pageContext.request.contextPath}/home?action=login">Đăng nhập</a></li>
                    </c:if>
                    <c:if test="${User != null}">
                    ...
                    <c:forEach var="ProductShow" items="${listProductShow}">
                        <li class="span3">
                            <div class="product-box">
                                ...
                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"
                                   class="title">Tiêu đề : ${ProductShow.getBook_title()}</a><br/>
                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"
                                   class="category">Thể loại : ${ProductShow.getCategory_name()}</a><br/>
                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"
                                   class="category">Tác giả: ${ProductShow.getAuthorname()}</a><br/>
                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"
                                   class="category">Điểm đánh giá : ${ProductShow.getAvarage_rating()}</a><br/>
                            ...
                            <c:forEach var="Category" items="${categorys}">
                                <div class="checkbox checkbox-primary">
                                    <input id="checkbox11" type="checkbox" class="input-lg"
                                           value="${Category.getCategory_name()}"
                                           name="categorysearch">
                                ...
                                <div class="active item">
                                    <ul class="thumbnails listing-products">
                                        <li class="span3">
                                            <div class="product-box">
                                                <span class="sale_tag"></span>
                                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"><img
                                                        alt="" src="themes/images/cloth/laptop2.jpg"></a><br/>
                                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"
                                ...
                                <div class="item">
                                    <ul class="thumbnails listing-products">
                                        <li class="span3">
                                            <div class="product-box">
                                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"><img
                                                        alt="" src="themes/images/cloth/laptop4.png"></a><br/>
                                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"
                                                   class="title">${ProductShow.getBook_title()}</a><br/>
                                                <a href="Productdetail?ID_Product=<c:out value='${ProductShow.getID_Product()}' />"
                                                   class="category">${ProductShow.getCategory_name()}</a>
