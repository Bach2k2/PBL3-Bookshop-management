...
<div class="page-container">
    ...
    <div class="left-content">
        <div class="mother-grid-inner">
                    ...
                    <ul>
                        <li class="dropdown profile_details_drop">
                            ...
                            <ul class="dropdown-menu drp-mnu">
                                ...
                                <li><a href="/admin?action=show"><i class="fa fa-user"></i>Thông tin</a></li>
                                <li><a href="/home"><i class="fa fa-sign-out"></i> Đăng xuất</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/home">Trang chủ</a> <i class="fa fa-angle-right"></i></li>
            </ol>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                                <div class="list-group">
                                                    ...
                                                    <a href="sanpham.html" class="list-group-item">Quản lý Sách</a>
                                                    <a href="sanpham1.html" class="list-group-item">Quản lý thể loại</a>
                                                    <a href="sanpham2.html" class="list-group-item">Quản lý tác giả</a>
            ...
            <div class="copyrights">
                <p>© 2018 N5QPT. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a>
                </p>
            </div>
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu">
            <ul id="menu">
                <li><a href="index1.html"><i class="fa fa-tachometer"></i> <span>Trang chủ</span>
                    <div class="clearfix"></div>
                </a></li>
